...
export const pagesContent = {
  home: {
    ...
    hero: {
      ...
      primaryCta: { label: 'Read latest stories', href: '/articles' },
      secondaryCta: { label: 'Explore visuals', href: '/image-sharing' },
    ...
    intro: {
      ...
      secondaryLink: { label: 'See visuals', href: '/image-sharing' },
    },
    cta: {
